...
As an open-source project, Devant documentation welcomes contributions from the community. Before you contribute, read the following guidelines to understand how you can contribute:
...
3. The `docs-devant/en/docs/` directory contains all the `.md` files with content. Find the relevant location and do the modification.
...
4. Navigate to the `docs-devant/en/` directory in the terminal and build the repository with the following command:
