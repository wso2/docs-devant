...
!!! note
    ...
    - This guide assumes you have completed steps 1 to 4 in [RAG (Retrieval-Augmented Generation)](rag-ingestion.md).
...
- To schedule ingestion for a specific time, click the **Schedule** button and select your desired time.

You can verify successful ingestion by reviewing the automation logs.

![RAG schedule](../assets/img/ai/rag-application/rag-schedule.gif)
